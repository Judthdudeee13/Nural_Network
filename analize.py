...
filename = "48_pool_2pct_pm0.2_grid.csv"
...
filename = "48_pool_2pct_pm0.2_10pct_1pm_grid.csv"
...
plt.xlabel("Generation")
plt.ylabel("Score")
plt.title("Neural Network Training 5 hidden")
...
plt.xlabel("Generation")
plt.ylabel("Average Score")
plt.title("Average Score Per 100 Generations 5 hidden")
